...
Page({
  data: {
    ...
    // leassonList: [],//文章列表
    actIndex: 'draw',
    apiUrl: config.url + "/wx/getwxarticless/26175",//青少儿书画26175；家电脑本机26243
    leassonId: '',
    ...
    searchdrawshow: false,//页面显示顺德分部-南沙分部……
  },
  ...
  changeMenu: function(e) {
    ...
    var apiUrl = config.url + '/wx/getwxarticless/' + url1; //文章列表接口地址
    this.setData({
      apiUrl: apiUrl,
